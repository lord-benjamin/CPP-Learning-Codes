...
int main()
{
    ...
    result = ++counter; //Note the pre-increment //FIRST counter will become 11 THEN result will become 11
    cout << "Counter: " << counter << endl;
    ...
    result = counter++; //Note the post-increment //FIRST result will become 10 THEN counter will become 11
    cout << "Counter: " << counter << endl;
    cout << "Result: " << result << endl;
