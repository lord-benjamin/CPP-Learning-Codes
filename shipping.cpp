...
int main()
{
    ...
    cout << "***** Welcome to the shipping cost calculator *****" << endl << endl;
    cout << "Enter length, width and height of the package separated by spaces: ";
    cin >> length >> width >> height;

    if(length > max_dimension_length || width > max_dimension_length || height > max_dimension_length){
        cout << "Sorry, package rejected - dimension(s) exceeded!" << endl;
    }
    else{
        double package_cost{};
        ...
        cout << fixed << setprecision(2);  //prints dollars nicely upto 2 decimal places
