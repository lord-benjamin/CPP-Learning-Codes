...
void global_example(){
    ...
    num *= 2;
    cout << "Global num is: " << num << " is global_example - end" << endl;
}
...
void local_example(int x){
    ...
    //num1 in main is not in scope - so it can't be used here
}
...
int main()
{
    ...
    { //creates a new level of scope
        ...
        cout << "Inner block in main can see out - num1: " << num1 << endl;
    }
